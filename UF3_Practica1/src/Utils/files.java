...
public class files {
    ...
    /**
     * Llama declare_FR_BR, una vez tenemos reader y buffer lee el fichero entero
     * @param adress
     * @throws FileNotFoundException
     * @throws IOException 
     */
    ...
    /**
     * Llama declare_FR_BR, una vez tenemos reader y buffer lee el fichero entero, pero solo se guarda y imprime la linea que le hemos pedido
     * @param adress
     * @param message
     * @param defaultResult
     * @throws FileNotFoundException
    ...
    /**
     * Llama declare_FW_PW y una vez tenemos el writer i pw, pw.print imprime el mensaje en el archivo que hemos indicado anteriormente 
     * @param adress
     * @param message
     * @param dontOverwrite
     * @throws IOException 
